...
const ADMIN_ROUTES = ['/admin', '/admin/settings', '/admin/users', '/admin/settings/capdev', '/admin/settings/request'];
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const backHref = isSettingsPage && safeSettingsReturnPath
    ...
    : statusRouteMatch
      ? statusRouteMatch[1]
      : pathname === '/admin/users' || pathname === '/admin/settings/capdev' || pathname === '/admin/settings/request'
        ? '/admin/settings'
        : '/admin';
